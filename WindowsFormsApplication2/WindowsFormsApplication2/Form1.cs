...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void radioButtonQ1A1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                labelFeedback1.ForeColor = Color.Red;
                labelFeedback1.Text = "\u00fb";  //cross
                q1Correct = false;
            }
            else
            {
        ...
        private void radioButtonQ1A2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                labelFeedback1.ForeColor = Color.Green;
                labelFeedback1.Text = "\u00fc";  //tick
                q1Correct = true;
            }
            else
            {
        ...
        private void radioButtonQ2A1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                labelFeedback2.ForeColor = Color.Red;
                labelFeedback2.Text = "\u00fb";  //cross
                q2Correct = false;
            }
            else
            {
        ...
        private void radioButtonQ2A2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                labelFeedback2.ForeColor = Color.Green;
                labelFeedback2.Text = "\u00fc";  //tick
                q2Correct = true;
            }
            else
            {
        ...
        private void radioButtonQ3A1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                labelFeedback3.ForeColor = Color.Red;
                labelFeedback3.Text = "\u00fb";  //cross
                q3Correct = false;
            }
            else
            {
        ...
        private void radioButtonQ3A3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                labelFeedback3.ForeColor = Color.Green;
                labelFeedback3.Text = "\u00fc";  //tick
                q3Correct = true;
            }
            else
            {
